export const places = [
  ...
  { 
    ...
    image: "https://images.unsplash.com/photo-1549429141-8f553f1f7ca4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", 
    services: {
      guides: [{ name: "Youssef", role: "Guide Historique", description: "Expert en architecture andalouse.", price: "400 MAD/jour" }],
  ...
  { 
    ...
    title: "Les Souks", 
    category: "Marché", 
    description: "Un labyrinthe coloré de marchés traditionnels remplis d'artisanat local.", 
    coordinates: "31.6271, -7.9891", 
    image: "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", 
    services: {
      guides: [{ name: "Omar", role: "Guide Local", description: "Il connaît tous les raccourcis et les meilleurs artisans.", price: "250 MAD/jour" }],
      activites: [{ name: "Dégustation Street Food", role: "Gastronomie", description: "Goûtez aux saveurs authentiques du souk.", price: "300 MAD" }]
    } 
  },
  { 
    id: 4, 
    ...
    image: "https://images.unsplash.com/photo-1590089849504-20412e106da4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", 
    services: {
